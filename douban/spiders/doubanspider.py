...
class DoubanspiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
        data = {
            ...
            'form_email': '515824031@qq.com',
            'form_password': '123456miao',
            'remember': 'on',
            'login': '登录',
        }
        ...
        if captcha_image:
            ...
            captchaid = response.xpath('//input[@name="captcha-id"]/@value').get()
    ...
    def parse_page(self, response):
        ...
        url = 'https://www.douban.com/people/188842836/'
        yield scrapy.Request(url=url, callback=self.xiugai)

    #  修改个人信息
    def xiugai(self, response):
        ck = response.xpath('//input[@name="ck"]/@value').get()
        data = {'ck': ck, 'signature': '云游十方'}
        edit_url = 'https://www.douban.com/j/people/188842836/edit_signature'
